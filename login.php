...
<?php if ($bConnectError || $bSubscribeError): ?>
...
<form class="form-horizontal" action="index.php?controller=back&method=login" method="post" name="login" role="form">
...
<form class="form-horizontal" action="index.php?controller=back&method=login" method="post" name="subscribe" role="form">
    <div class="form-group">
        <label for="login" class="col-sm-2 control-label">Login</label>
